  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-lg origin-center animate-bubble-pop overflow-hidden rounded-2xl border border-divider bg-surface-elevated text-ink shadow-bubble"
      >
